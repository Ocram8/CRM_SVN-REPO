...
<div class="container">
	<div class="row row-offcanvas row-offcanvas-right">
		<div class="col-xs-12 col-sm-9">
			...
			<p class="lead">Ver os dados da lead.</p>
			...
			<div class="col-lg-10">
				...
				<form action="">
					...
					<fieldset>
						...
						<div class="col-lg-6">
							<label for="num" title="Introduza o número da campanha comercial">Número da lead</label>
							<p class="form-control-static">[Número da lead]</p>
							</br> <label for="nome" title="Altere o nome da lead">Nome</label>
							<p class="form-control-static">[Nome da lead]</p>
							</br> <label for="email" title="Altere a Empresa">Empresa</label>
							<p class="form-control-static">[Empresa]</p>
							</br> <label for="email" title="Altere a Origem">Origem</label>
							<p class="form-control-static">[Origem]</p>
							</br> <label for="email" title="Altere as observações da lead">Observações</label>
