			...
			<div class="col-lg-10">
				<form action="">
					<fieldset>
						...
						<div class="col-lg-8">
							<label for="nome" title="Altere o nome do Administrador"><?php echo $lang_personal_index_text_6;?></label> <input type="text" class="form-control" placeholder="<?php echo $lang_personal_index_placeholder_7;?>" title="<?php echo $lang_personal_index_title_8;?>" id="name"> <span class="help-block"><?php echo $lang_personal_index_text_9;?></span>
						</div>
						<div class="col-lg-6">
							<label for="email" title="Altere o correiro eletrónico do Administrador"><?php echo $lang_personal_index_text_10;?></label> <input type="email" class="form-control" placeholder="<?php echo $lang_personal_index_placeholder_11;?>" title="<?php echo $lang_personal_index_title_12;?>" id="email">
							...
							<button type="submit" class="btn btn-lg btn-primary"><?php echo $lang_personal_index_text_30;?></button>
						</div>
					</fieldset>
				</form>
			</div>
